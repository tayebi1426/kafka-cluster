...
trust_store_private_key_file=""
  ...
  keytool -keystore $TRUSTSTORE_WORKING_DIRECTORY/$DEFAULT_TRUSTSTORE_FILENAME \
    -alias $ROOT_CERT_ALIAS -import -file $TRUSTSTORE_WORKING_DIRECTORY/ca-cert \
...
keytool -keystore $trust_store_file -export -alias $ROOT_CERT_ALIAS -rfc -file $CA_CERT_FILE -keypass $PASS -storepass $PASS
